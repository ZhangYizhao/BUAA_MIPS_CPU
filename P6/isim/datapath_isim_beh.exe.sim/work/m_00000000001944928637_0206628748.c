...
#endif
static const char *ng0 = "E:/CO_cpu/P6_Z/pc_F.v";
static int ng1[] = {0, 0};
static int ng2[] = {1, 0};
static int ng3[] = {2, 0};
static int ng4[] = {4, 0};
...
LAB98:    t251 = *((unsigned int *)t184);
    t252 = (~(t251));
    t253 = *((unsigned int *)t209);
    t254 = (t252 || t253);
    if (t254 > 0)
        goto LAB99;
...
LAB104:    memcpy(t183, t255, 8);

LAB105:    goto LAB66;

LAB67:    xsi_vlog_unsigned_bit_combine(t111, 32, t141, 32, t183, 32);
    goto LAB71;
...
LAB84:    xsi_vlog_unsigned_bit_combine(t141, 32, t173, 32, t178, 32);
    goto LAB88;

LAB86:    memcpy(t141, t173, 8);
    goto LAB88;
...
LAB101:    xsi_vlog_unsigned_bit_combine(t183, 32, t213, 32, t255, 32);
    goto LAB105;
...
LAB114:    t244 = (t0 + 1208U);
    t245 = *((char **)t244);
    goto LAB115;

LAB116:    t244 = (t0 + 1048U);
    t250 = *((char **)t244);
    goto LAB117;

LAB118:    xsi_vlog_unsigned_bit_combine(t213, 32, t245, 32, t250, 32);
    goto LAB122;

LAB120:    memcpy(t213, t245, 8);
    goto LAB122;
...
extern void work_m_00000000001944928637_0206628748_init()
{
	static char *pe[] = {(void *)Cont_36_0,(void *)Initial_43_1,(void *)Always_47_2};
	xsi_register_didat("work_m_00000000001944928637_0206628748", "isim/datapath_isim_beh.exe.sim/work/m_00000000001944928637_0206628748.didat");
