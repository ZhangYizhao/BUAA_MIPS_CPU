...
#endif
static const char *ng0 = "E:/CO_cpu/P4/ATdecoder.v";
static int ng1[] = {0, 0};
...
LAB37:    xsi_vlog_unsigned_bit_combine(t79, 4, t151, 4, t156, 4);
    goto LAB41;
...
LAB64:    if (*((unsigned int *)t176) > 0)
        goto LAB65;

LAB66:    memcpy(t175, t194, 8);
...
LAB63:    xsi_vlog_unsigned_bit_combine(t175, 4, t189, 4, t194, 4);
    goto LAB67;

LAB65:    memcpy(t175, t189, 8);
    goto LAB67;
...
LAB98:    t246 = ((char*)((ng18)));
    goto LAB99;

LAB100:    t253 = (t0 + 3768U);
    t254 = *((char **)t253);
    memset(t252, 0, 8);
    t253 = (t254 + 4);
...
LAB102:    xsi_vlog_unsigned_bit_combine(t232, 4, t246, 4, t251, 4);
    goto LAB106;
...
LAB113:    t270 = ((char*)((ng12)));
    goto LAB114;

LAB115:    xsi_vlog_unsigned_bit_combine(t251, 4, t265, 4, t270, 4);
    goto LAB119;
...
LAB56:    t182 = (t0 + 11976);
    ...
    *((unsigned int *)t192) = (t194 | t188);
    xsi_driver_vfirst_trans(t182, 0, 4);
    t195 = (t0 + 10728);
    *((int *)t195) = 1;
...
LAB38:    t263 = (t0 + 12040);
    ...
    *((unsigned int *)t273) = (t275 | t269);
    xsi_driver_vfirst_trans(t263, 0, 4);
    t276 = (t0 + 10744);
    *((int *)t276) = 1;
...
LAB34:    xsi_vlog_unsigned_bit_combine(t3, 32, t100, 32, t114, 32);
    goto LAB38;
...
LAB89:    memcpy(t226, t262, 8);

LAB90:    goto LAB68;

LAB69:    xsi_vlog_unsigned_bit_combine(t114, 32, t212, 32, t226, 32);
    goto LAB73;
...
LAB82:    t257 = ((char*)((ng19)));
    goto LAB83;

LAB84:    t262 = ((char*)((ng1)));
    goto LAB85;

LAB86:    xsi_vlog_unsigned_bit_combine(t226, 32, t257, 32, t262, 32);
    goto LAB90;
...
extern void work_m_00000000003816977114_3345919226_init()
{
	static char *pe[] = {(void *)Cont_33_0,(void *)Cont_34_1,(void *)Cont_36_2,(void *)Cont_37_3,(void *)Cont_38_4,(void *)Cont_39_5,(void *)Cont_40_6,(void *)Cont_41_7,(void *)Cont_42_8,(void *)Cont_43_9,(void *)Cont_44_10,(void *)Cont_45_11,(void *)Cont_46_12,(void *)Cont_47_13,(void *)Cont_48_14,(void *)Cont_49_15,(void *)Cont_51_16,(void *)Cont_60_17,(void *)Cont_62_18,(void *)Cont_65_19};
	xsi_register_didat("work_m_00000000003816977114_3345919226", "isim/mips_isim_beh.exe.sim/work/m_00000000003816977114_3345919226.didat");
